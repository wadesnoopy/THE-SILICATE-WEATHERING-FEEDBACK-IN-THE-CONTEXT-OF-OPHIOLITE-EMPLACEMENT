...
Alk_total = ones(num_points,num_monte) * -1;
...
C_carbb_monte = F_C_carbb(C_carbw_monte, C_ma_monte, C_orgw_monte, C_plume_monte, dC_ma_monte, ...
    dC_orgb_monte, dC_orgw_monte, dC_carbb_monte, dC_carbw_monte, dC_plume_monte);

C_orgb_monte = F_C_orgb(C_carbw_monte, C_ma_monte, C_orgw_monte, C_plume_monte, dC_ma_monte, ...
    dC_orgb_monte, dC_orgw_monte, dC_carbb_monte, dC_carbw_monte, dC_plume_monte);

A_rev_monte = F_A_rev(A_basw_monte, A_carbw_monte, A_csiliw_monte, C_carbw_monte, ...
    C_ma_monte, C_orgw_monte, C_plume_monte, dC_ma_monte, dC_orgb_monte, dC_orgw_monte, ...
    dC_carbb_monte, dC_carbw_monte, dC_plume_monte);
...
for i=1:num_monte
    if (monte_check(i) > 0) && (CMg_total(1,i) >= 0) && (Sp_now_monte(i) >= 0) && (A_Jagoutz_monte_now(i) >= 0) && (Mg_mafic_monte_now(i) >= 0) && (Mg_ultra_monte_now(i) >= 0) && (Os_mafic_monte_now(i) >= 0) && ...
        ...
        K_csiliw_total(1,i) = F_K_csiliw(A_Jagoutz_monte_now(i), A_basw_monte(i), A_carbb_monte(i), A_carbw_monte(i), A_csiliw_monte(i), A_rev_monte(i), ...
            ...
            Mg_hy_monte(i), Mg_basw_monte(i), Mg_mafic_monte_now(i), Mg_carbw_monte(i), Mg_ultra_monte_now(i), Mg_csiliw_monte(i), Os_hy_monte(i), Os_cos_monte(i), Os_basw_monte(i), ...
            ...
            dC_carbb_now_monte(i), dC_carbw_monte(i), dC_plume_monte(i), dOs_hy_monte(i), dOs_cos_monte(i), dOs_basw_monte(i), ...
            ...
            dSr_mafic_monte(i), dSr_ocean_now_monte(i), dSr_carbw_monte(i), dSr_ultra_monte(i), dSr_csiliw_monte(i), der_dOs_ocean_monte(i), der_dSr_ocean_monte(i), t_interval);
        ...
        Alk_total(1,i) = A_Jagoutz_monte_now(i);
        
        if (K_csiliw_total(1,i) >= 0) && (K_basw_total(1,i) >= 0) && (K_sediw_total(1,i) >= 0) && (K_carbb_total(1,i) >= 0) && (K_orgb_total(1,i) >= 0)
            flag = flag + 1;
            Rsil_total(1,i) = (K_csiliw_total(1,i) * A_csiliw_monte(i) + K_basw_total(1,i) * A_basw_monte(i)) / (A_csiliw_monte(i) + A_basw_monte(i));
            Rsil_jagoutz_total(1,i) = (K_csiliw_total(1,i) * A_csiliw_monte(i) + K_basw_total(1,i) * A_basw_monte(i) + A_Jagoutz_monte_now(i)) / (A_csiliw_monte(i) + A_basw_monte(i));
            Imb_total(1,i) = Sp_now_monte(i) * C_ma_monte(i) + C_plume_monte(i) + K_sediw_total(1,i) * C_orgw_monte(i) - K_orgb_total(1,i) * C_orgb_monte(i) - K_csiliw_total(1,i) * A_csiliw_monte(i) / 2 - K_basw_total(1,i) * A_basw_monte(i) / 2 - A_Jagoutz_monte_now(i) / 2 + Sp_now_monte(i) *  CMg_total(1,i) / CMg_plei * A_rev_monte(i) / 2;
            mafic_total(1,i) =  K_basw_total(1,i) * A_basw_monte(i) + A_Jagoutz_monte_now(i);
            sil_total(1,i) =  K_basw_total(1,i) * A_basw_monte(i) + K_csiliw_total(1,i) * A_csiliw_monte(i) + A_Jagoutz_monte_now(i);
    ...
    for i=1:num_monte
        if (monte_check(i) > 0) && (CMg_total_old_monte(i) >= 0) && (Sp_now_monte(i) >= 0) && (A_Jagoutz_monte_now(i) >= 0) && (Mg_mafic_monte_now(i) >= 0) && (Mg_ultra_monte_now(i) >= 0) && (Os_mafic_monte_now(i) >= 0) && ...
            ...
            K_csiliw_total(j+1,i) = F_K_csiliw(A_Jagoutz_monte_now(i), A_basw_monte(i), A_carbb_monte(i), A_carbw_monte(i), A_csiliw_monte(i), A_rev_monte(i), ...
                CMg_total_old_monte(i), CMg_plei_monte(i), C_carbb_monte(i), C_carbw_monte(i), C_ma_monte(i), C_orgw_monte(i), C_plume_monte(i), ...
                Mg_hy_monte(i), Mg_basw_monte(i), Mg_mafic_monte_now(i), Mg_carbw_monte(i), Mg_ultra_monte_now(i), Mg_csiliw_monte(i), Os_hy_monte(i), Os_cos_monte(i), Os_basw_monte(i), ...
                Os_mafic_monte_now(i), Os_ocean_monte(i), Os_sediw_monte(i), Os_ultra_monte_now(i), Os_csiliw_monte(i), Sp_now_monte(i), Sr_hy_monte(i), Sr_dia_monte(i), Sr_basw_monte(i), ...
                Sr_mafic_monte_now(i), Sr_ocean_monte(i), Sr_carbw_monte(i), Sr_ultra_monte_now(i), Sr_csiliw_monte(i), V_ocean_monte(i), dC_ma_monte(i), dC_orgb_now_monte(i),dC_orgw_monte(i), ...
                dC_carbb_now_monte(i), dC_carbw_monte(i), dC_plume_monte(i), dOs_hy_monte(i), dOs_cos_monte(i), dOs_basw_monte(i), ...
            ...
            K_orgb_total(j+1,i) = F_K_orgb(A_Jagoutz_monte_now(i), A_basw_monte(i), A_carbb_monte(i), A_carbw_monte(i), A_csiliw_monte(i), A_rev_monte(i), ...
                CMg_total_old_monte(i), CMg_plei_monte(i), C_carbb_monte(i), C_carbw_monte(i), C_ma_monte(i), C_orgb_monte(i), C_orgw_monte(i), C_plume_monte(i), ...
                Mg_hy_monte(i), Mg_basw_monte(i), Mg_mafic_monte_now(i), Mg_carbw_monte(i), Mg_ultra_monte_now(i), Mg_csiliw_monte(i), Os_hy_monte(i), Os_cos_monte(i), Os_basw_monte(i), ...
                Os_mafic_monte_now(i), Os_ocean_monte(i), Os_sediw_monte(i), Os_ultra_monte_now(i), Os_csiliw_monte(i), Sp_now_monte(i), Sr_hy_monte(i), Sr_dia_monte(i), Sr_basw_monte(i), ...
                Sr_mafic_monte_now(i), Sr_ocean_monte(i), Sr_carbw_monte(i), Sr_ultra_monte_now(i), Sr_csiliw_monte(i), V_ocean_monte(i), dC_ma_monte(i), dC_orgb_now_monte(i),dC_orgw_monte(i), ...
                dC_carbb_now_monte(i), dC_carbw_monte(i), dC_plume_monte(i), dOs_hy_monte(i), dOs_cos_monte(i), dOs_basw_monte(i), ...
            ...
            Alk_total(j+1,i) = A_Jagoutz_monte_now(i);
            ...
            if (K_csiliw_total(j+1,i) >= 0) && (K_basw_total(j+1,i) >= 0) && (K_sediw_total(j+1,i) >= 0) && (K_carbb_total(j+1,i) >= 0) && (K_orgb_total(j+1,i) >= 0) && (CMg_total(j+1,i) >= 0)
                flag = flag + 1;
                Rsil_total(j+1,i) = (K_csiliw_total(j+1,i) * A_csiliw_monte(i) + K_basw_total(j+1,i) * A_basw_monte(i)) / (A_csiliw_monte(i) + A_basw_monte(i));
                Rsil_jagoutz_total(j+1,i) = (K_csiliw_total(j+1,i) * A_csiliw_monte(i) + K_basw_total(j+1,i) * A_basw_monte(i) + A_Jagoutz_monte_now(i)) / (A_csiliw_monte(i) + A_basw_monte(i));           
                Imb_total(j+1,i) = Sp_now_monte(i) * C_ma_monte(i) + C_plume_monte(i) + K_sediw_total(j+1,i) * C_orgw_monte(i) - K_orgb_total(j+1,i) * C_orgb_monte(i) - K_csiliw_total(j+1,i) * A_csiliw_monte(i) / 2 - K_basw_total(j+1,i) * A_basw_monte(i) / 2 - A_Jagoutz_monte_now(i) / 2 + Sp_now_monte(i) *  CMg_total(j+1,i) / CMg_plei * A_rev_monte(i) / 2;
                mafic_total(j+1,i) =  K_basw_total(j+1,i) * A_basw_monte(i) + A_Jagoutz_monte_now(i);
                sil_total(j+1,i) =  K_basw_total(j+1,i) * A_basw_monte(i) + K_csiliw_total(j+1,i) * A_csiliw_monte(i) + A_Jagoutz_monte_now(i);
...
Alk_total_origin = Alk_total;
Alk_total(Alk_total<0) = NaN;
Alk_ave = nanmean(Alk_total, 2);
Alk_std = nanstd(Alk_total, 0, 2);
Alk_low = Alk_ave - Alk_std;
Alk_high = Alk_ave + Alk_std;

% Create file directory

file_dir = strcat('norm_high_rate', num2str(t_interval / 1000), 'ky_', num2str(num_monte), 'monte');
...
if ispc
    book_name = strcat(file_dir, '\', file_dir, '.xlsx');
    csv_name = strcat(file_dir, '\', file_dir, '.csv');
    sil_name = strcat(file_dir, '\', file_dir, '_sil.jpg');
    bas_name = strcat(file_dir, '\', file_dir, '_bas.jpg');
    sed_name = strcat(file_dir, '\', file_dir, '_sed.jpg');
    car_name = strcat(file_dir, '\', file_dir, '_car.jpg');
    oc_name = strcat(file_dir, '\', file_dir, '_oc.jpg');
    cmg_name = strcat(file_dir, '\', file_dir, '_cmg.jpg');
    suc_name = strcat(file_dir, '\', file_dir, '_success.jpg');
    Rsil_name = strcat(file_dir, '\', file_dir, '_Rsil.jpg');
    Rsil_jagoutz_name = strcat(file_dir, '\', file_dir, '_Rsil_jagoutz.jpg');
else
    book_name = strcat(file_dir, '/', file_dir, '.xlsx');
    csv_name = strcat(file_dir, '/', file_dir, '.csv');
    sil_name = strcat(file_dir, '/', file_dir, '_sil.jpg');
...
headers = {'Age (Ma)', 'success percent', 'silicate_weather', 'silw_sd', 'basalt_weather', 'basw_sd', ...
    ...
    'Rsil', 'Rsil_sd', 'Rsil_jagoutz', 'Rsil_jagoutz_sd', 'CO2', 'CO2_err', 'Imb', 'Imb_err', 'F_csiliw_ave', ...
    'F_csiliw_sd', 'F_basw_ave', 'F_basw_sd', 'F_carbw_ave', 'F_carbw_sd', 'F_orgw_ave', 'F_orgw_sd',...
    'F_carbb_ave', 'F_carbb_sd', 'F_orgb_ave', 'F_orgb_sd', 'mafic_total_ave', 'mafic_total_sd', 'sil_total_ave', 'sil_total_sd', 'alk_total', 'alk_total_sd'};
...
whole_data = [age_all_plot_book, success_array, K_csiliw_ave, K_csiliw_std, K_basw_ave, K_basw_std, K_sediw_ave, ...
    ...
    Rsil_jagoutz_ave, Rsil_jagoutz_std, co2_total, co2_total_err, Imb_ave, Imb_std, F_csiliw_ave, F_csiliw_std, ...
    F_basw_ave, F_basw_std, F_carbw_ave, F_carbw_std, F_orgw_ave, F_orgw_std, F_carbb_ave, F_carbb_std, F_orgb_ave, ...
    F_orgb_std, mafic_total_ave, mafic_total_std, sil_total_ave, sil_total_std, Alk_ave, Alk_std];
