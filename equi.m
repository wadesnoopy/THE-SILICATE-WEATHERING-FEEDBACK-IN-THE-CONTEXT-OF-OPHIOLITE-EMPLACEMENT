% This is to create the symbolic equations for Model 3
...
f_C = K_sediw * C_carbw + K_sediw * C_orgw + Sp * C_ma + C_plume - K_carbb * C_carbb - K_orgb * C_orgb == 0;

f_dC = K_sediw * C_carbw * dC_carbw + K_sediw * C_orgw * dC_orgw + Sp * C_ma * dC_ma + ...
    C_plume * dC_plume - K_carbb * C_carbb * dC_carbb - K_orgb * C_orgb * dC_orgb == 0;
...
f_dSr = K_csiliw * Sr_csiliw * (dSr_csiliw - dSr_ocean) + K_basw * Sr_basw *(dSr_basw - dSr_ocean) + ...
    K_sediw * Sr_carbw * (dSr_carbw - dSr_ocean) + Sp * CMg / CMg_plei * Sr_hy * (dSr_hy - dSr_ocean) + Sr_dia * ...
...
f_dOs = K_csiliw * Os_csiliw * (dOs_csiliw - dOs_ocean) + K_basw * Os_basw *(dOs_basw - dOs_ocean) + ...
    K_sediw * Os_sediw * (dOs_sediw - dOs_ocean) + Sp * CMg / CMg_plei * Os_hy * (dOs_hy - dOs_ocean) + Os_cos * ...
    (dOs_cos - dOs_ocean) + Os_mafic * (dOs_mafic - dOs_ocean) + Os_ultra * (dOs_ultra - dOs_ocean) - Os_ocean * der_dOs_ocean == 0;

f_CMg = K_csiliw * Mg_csiliw + K_basw * Mg_basw + K_sediw * Mg_carbw + Mg_mafic + Mg_ultra - Sp * CMg / CMg_plei * ...
...
f_C_plei = C_carbw + C_orgw + C_ma + C_plume - C_carbb - C_orgb == 0;

f_dC_plei = C_carbw * dC_carbw + C_orgw * dC_orgw + C_ma * dC_ma + ...
    C_plume * dC_plume - C_carbb * dC_carbb - C_orgb * dC_orgb == 0;
